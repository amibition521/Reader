...
import com.amibtion.mvp.reader.injector.components.DaggerNewsListComponent;
...
import com.amibtion.mvp.reader.utils.SliderHelper;
...
public class NewsListFragment extends BaseFragment<IBasePresenter> implements INewsListView {
    ...
    public static NewsListFragment newInstance(String mNewsId){
        NewsListFragment fragment = new NewsListFragment();
        Bundle bundle = new Bundle();
        bundle.putString(NEWS_TYPE_KEY,mNewsId);
